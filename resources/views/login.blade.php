            ...
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-xl xl:p-0 dark:bg-neutral-950 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8 w-96">
                    ...
                    <form class="space-y-4 md:space-y-6" action="/login" method="post">
                        ...
                        <button type="submit" class="w-full text-white border-white hover:bg-neutral-800 border hover:bg-primary-700 focus:ring-4 focus:outline-none focus:ring-primary-300 font-medium rounded-lg text-sm px-5 py-2.5 text-center dark:bg-primary-600 dark:hover:bg-primary-700 dark:focus:ring-primary-800">Login</button>
                        <p class="text-sm font-light text-gray-500 dark:text-gray-400">
                            Don't have an account? <a href="/register" class="font-medium text-neutral-200 underline">Register here</a>
                        </p>
                    </form>
                </div>
            </div>
